                        ...
                        <div class="flex">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" name="fnameSearch" class="form-control"
                                           placeholder="Enter Title For Search" value="{{ old('fnameSearch') }}">
                                </div>
                            </div>
                            <div class="">
                                <di class="form-group ">
                                    ...
                                    <td class="py-4 px-6">
                                        <button type="button"
                                            ...
                                            <a class="btn btn-info"
                                               href="{{ route('users.show',$user->id) }}">مشاهده</a></button>
                                        <button type="button"
