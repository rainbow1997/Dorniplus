...
<form method="POST" action="{{ route('register')}}" class="rtl text-right" enctype="multipart/form-data" style="font-family:'Shabnam'">
    ...
    <div class="mt-4">
        ...
        <x-input id="birth" class="datepicker" style="font-family:arial !important;direction:lrt;" type="text" name="birth" :value="old('birth')" required autofocus />
    ...
    <div class="mt-4">
        ...
        <x-input id="avatar" class="block mt-1 w-full" type="file" name="avatar" :value="old('avatar')" autofocus />
    </div>
