                        ...
                        <div class=" margin-tb">
                            ...
                            <div class="pull-right">
                                <button type="button"
                                    ...
                                    <a class="btn btn-success" href="{{ route(getLocaleName().'.posts.create') }}"> ساخت مطلب جدید</a>
                                    ...
                                    <td class="py-4 px-6">
                                        <button type="button"
                                            ...
                                            <a class="btn btn-primary"
                                               href="{{ route('posts.edit',$post->id) }}">ویرایش</a>
                                        </button>
                                        {!! Form::open(['method' => 'DELETE','route' => [getLocaleName().'.posts.destroy', $post->id],'style'=>'display:inline']) !!}
