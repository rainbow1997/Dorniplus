                    ...
                    <div class="flex flex-wrap -m-4 text-center">
                        <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div class="bg-blue-500 px-4 py-6 rounded-lg">
                                <svg class="text-white w-12 h-12 mb-3 inline-block" fill="none" stroke="currentColor"
                                     stroke-linecap="round" stroke-linejoin="round"
                                     stroke-width="2" viewBox="0 0 24 24">
                                    <path d="M8 17l4 4 4-4m-4-5v9"></path>
                                    <path d="M20.88 18.09A5 5 0 0018 9h-1.26A8 8 0 103 16.29"></path>
                                </svg>
                                <h2 class=" font-medium text-3xl text-white">{{ dashboardData.posts }}</h2>
                                <p class="leading-relaxed text-white">مطالب</p>
                            </div>
                        </div>
                        <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div class="bg-green-500 px-4 py-6 rounded-lg">
                                ...
                                <h2 class="font-medium text-3xl text-white">{{ dashboardData.users }}</h2>
                        ...
                        <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div class="bg-yellow-400 px-4 py-6 rounded-lg">
                                ...
                                <h2 class="title-font font-medium text-3xl text-white">{{ dashboardData.comments }}</h2>
                                <p class="leading-relaxed text-white">نظرات</p>
                            </div>
                        </div>
                        <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div class="bg-indigo-500 px-4 py-6 rounded-lg">
                                ...
                                <h2 class="title-font font-medium text-3xl text-white">{{
                                        dashboardData.unReadComments
                                    }}</h2>
                                <p class="leading-relaxed text-white">نظرات دیده نشده</p>
                            </div>
                        </div>
                    </div>
                </div>
...
import Masterpage from "@/Layouts/AdminPanel/Layout/Masterpage.vue";</script>
