                    ...
                    <div class="flex flex-col space-y-8">
                        <div class="flex flex-col">
                            ...
                            <div class="my-2 flex flex-row justify-between ">
                                <Link type="button" :href="route('site_admin.create')" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" >افزودن مدیر</link>
                                ...
                                <tr v-for="user in users.data"
                                    ...
                                    <td class="py-4 flex flex-row" v-if="isFromSiteAdminAdd!=true">
                                        ...
                                        <button
                                            ...
                                            <a class="btn btn-primary" @click="destroyUser(user.id)">حذف کاربر</a></button>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
