...
export default {
    components:{
    Head,Link,useForm,BreezeButton,BreezeGuestLayout,BreezeInput,BreezeLabel,BreezeValidationErrors
},
data(){
    return{
        cities:{},
    ...
    <BreezeGuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div>
                ...
                <BreezeInput id="gender" name="gender" type="radio" class="mt-1 " v-model="form.gender" required autofocus autocomplete="gender" value="male" @change="genderChange($event)"/>مذکر
                <BreezeInput id="gender2" name="gender" type="radio" class="mt-1" v-model="form.gender" required autofocus autocomplete="gender" value="female" @change="genderChange($event)"/>مونث

            </div>
            <div v-show="form.gender == 'male'">
                <BreezeLabel  value="وضعیت نظام وظیفه" />
                <BreezeInput id="military_status" name="military_status" type="radio" class="mt-1" v-model="form.military_status"  autofocus autocomplete="military_status" value="permanent_exemption" />معاف دائم
                <BreezeInput id="military_status2" name="military_status" type="radio" class="mt-1 " v-model="form.military_status"  autofocus autocomplete="military_status" value="temporary_exemption" />معاف موقت
                <BreezeInput id="military_status3" name="military_status" type="radio" class="mt-1 " v-model="form.military_status"  autofocus autocomplete="military_status" value="done" />پایان خدمت
            </div>
             <div class="mt-4">
