            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <form enctype="multipart/form-data" method="post" @submit.prevent="submit(post)">
                            <div>
                            ...
                            <div class="mt-2">
                                ...
                                <p id="post_image_help" class="mt-1 text-sm text-gray-500 dark:text-gray-300">PNG, JPG,
                                    JPEG or GIF (MAX
                                    :200KB).</p>
